...
class Join2CreateCog(commands.Cog):
    ...
    @commands.slash_command(name = "join2create-board", description = "Create a join2create board")
    async def join2create_board(self, ctx: discord.ApplicationContext) -> None:
